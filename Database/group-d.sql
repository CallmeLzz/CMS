...
-- Database: `group-d`
--
CREATE DATABASE IF NOT EXISTS `group-d` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `group-d`;

-- --------------------------------------------------------

--
-- Table structure for table `eibd1_assets`
--

DROP TABLE IF EXISTS `eibd1_assets`;
CREATE TABLE `eibd1_assets` (
...
--
-- Dumping data for table `eibd1_assets`
--

INSERT INTO `eibd1_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Table structure for table `eibd1_associations`
--

DROP TABLE IF EXISTS `eibd1_associations`;
CREATE TABLE `eibd1_associations` (
...
--
-- Table structure for table `eibd1_banners`
--

DROP TABLE IF EXISTS `eibd1_banners`;
CREATE TABLE `eibd1_banners` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `eibd1_banner_clients`
--

DROP TABLE IF EXISTS `eibd1_banner_clients`;
CREATE TABLE `eibd1_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Table structure for table `eibd1_banner_tracks`
--

DROP TABLE IF EXISTS `eibd1_banner_tracks`;
CREATE TABLE `eibd1_banner_tracks` (
...
--
-- Table structure for table `eibd1_categories`
--

DROP TABLE IF EXISTS `eibd1_categories`;
CREATE TABLE `eibd1_categories` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `eibd1_categories`
--

INSERT INTO `eibd1_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 278, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 278, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 278, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 278, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 278, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 278, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Table structure for table `eibd1_contact_details`
--

DROP TABLE IF EXISTS `eibd1_contact_details`;
CREATE TABLE `eibd1_contact_details` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `eibd1_content`
--

DROP TABLE IF EXISTS `eibd1_content`;
CREATE TABLE `eibd1_content` (
...
--
-- Dumping data for table `eibd1_contentitem_tag_map`
--

INSERT INTO `eibd1_contentitem_tag_map` (`type_alias`, `core_content_id`, `content_item_id`, `tag_id`, `tag_date`, `type_id`) VALUES
('com_content.article', 1, 1, 2, '2013-11-16 06:00:00', 1);

-- --------------------------------------------------------

--
-- Table structure for table `eibd1_content_frontpage`
--

DROP TABLE IF EXISTS `eibd1_content_frontpage`;
CREATE TABLE `eibd1_content_frontpage` (
...
--
-- Table structure for table `eibd1_content_rating`
--

DROP TABLE IF EXISTS `eibd1_content_rating`;
CREATE TABLE `eibd1_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `eibd1_content_types`
--

DROP TABLE IF EXISTS `eibd1_content_types`;
CREATE TABLE `eibd1_content_types` (
...
--
-- Dumping data for table `eibd1_content_types`
--

INSERT INTO `eibd1_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Table structure for table `eibd1_core_log_searches`
--

DROP TABLE IF EXISTS `eibd1_core_log_searches`;
CREATE TABLE `eibd1_core_log_searches` (
...
--
-- Table structure for table `eibd1_extensions`
--

DROP TABLE IF EXISTS `eibd1_extensions`;
CREATE TABLE `eibd1_extensions` (
...
--
-- Dumping data for table `eibd1_extensions`
--

INSERT INTO `eibd1_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"LIB_JOOMLA","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"https:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"3a36f3ea4f0ef7d7934105fa7a958d98"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{"name":"plg_system_updatenotification","type":"plugin","creationDate":"May 2015","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION","group":"","filename":"updatenotification"}', '{"lastrun":1479815276}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(454, 'plg_system_stats', 'plugin', 'stats', 'system', 0, 1, 1, 0, '{"name":"plg_system_stats","type":"plugin","creationDate":"November 2013","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_STATS_XML_DESCRIPTION","group":"","filename":"stats"}', '{"mode":3,"lastrun":1479446446,"unique_id":"86555e1dc3451fdb627ca4f4b370c7ab4e8d7802","interval":12}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Table structure for table `eibd1_finder_links`
--

DROP TABLE IF EXISTS `eibd1_finder_links`;
CREATE TABLE `eibd1_finder_links` (
...
--
-- Table structure for table `eibd1_finder_links_terms0`
--

DROP TABLE IF EXISTS `eibd1_finder_links_terms0`;
CREATE TABLE `eibd1_finder_links_terms0` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `eibd1_finder_links_terms1`
--

DROP TABLE IF EXISTS `eibd1_finder_links_terms1`;
CREATE TABLE `eibd1_finder_links_terms1` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `eibd1_finder_links_terms2`
--

DROP TABLE IF EXISTS `eibd1_finder_links_terms2`;
CREATE TABLE `eibd1_finder_links_terms2` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `eibd1_finder_links_terms3`
--

DROP TABLE IF EXISTS `eibd1_finder_links_terms3`;
CREATE TABLE `eibd1_finder_links_terms3` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `eibd1_finder_links_terms4`
--

DROP TABLE IF EXISTS `eibd1_finder_links_terms4`;
CREATE TABLE `eibd1_finder_links_terms4` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `eibd1_finder_links_terms5`
--

DROP TABLE IF EXISTS `eibd1_finder_links_terms5`;
CREATE TABLE `eibd1_finder_links_terms5` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `eibd1_finder_links_terms6`
--

DROP TABLE IF EXISTS `eibd1_finder_links_terms6`;
CREATE TABLE `eibd1_finder_links_terms6` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `eibd1_finder_links_terms7`
--

DROP TABLE IF EXISTS `eibd1_finder_links_terms7`;
CREATE TABLE `eibd1_finder_links_terms7` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `eibd1_finder_links_terms8`
--

DROP TABLE IF EXISTS `eibd1_finder_links_terms8`;
CREATE TABLE `eibd1_finder_links_terms8` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `eibd1_finder_links_terms9`
--

DROP TABLE IF EXISTS `eibd1_finder_links_terms9`;
CREATE TABLE `eibd1_finder_links_terms9` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `eibd1_finder_links_termsa`
--

DROP TABLE IF EXISTS `eibd1_finder_links_termsa`;
CREATE TABLE `eibd1_finder_links_termsa` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `eibd1_finder_links_termsb`
--

DROP TABLE IF EXISTS `eibd1_finder_links_termsb`;
CREATE TABLE `eibd1_finder_links_termsb` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `eibd1_finder_links_termsc`
--

DROP TABLE IF EXISTS `eibd1_finder_links_termsc`;
CREATE TABLE `eibd1_finder_links_termsc` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `eibd1_finder_links_termsd`
--

DROP TABLE IF EXISTS `eibd1_finder_links_termsd`;
CREATE TABLE `eibd1_finder_links_termsd` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `eibd1_finder_links_termse`
--

DROP TABLE IF EXISTS `eibd1_finder_links_termse`;
CREATE TABLE `eibd1_finder_links_termse` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `eibd1_finder_links_termsf`
--

DROP TABLE IF EXISTS `eibd1_finder_links_termsf`;
CREATE TABLE `eibd1_finder_links_termsf` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `eibd1_finder_taxonomy`
--

DROP TABLE IF EXISTS `eibd1_finder_taxonomy`;
CREATE TABLE `eibd1_finder_taxonomy` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `eibd1_finder_taxonomy`
--

INSERT INTO `eibd1_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `eibd1_finder_taxonomy_map`
--

DROP TABLE IF EXISTS `eibd1_finder_taxonomy_map`;
CREATE TABLE `eibd1_finder_taxonomy_map` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `eibd1_finder_terms`
--

DROP TABLE IF EXISTS `eibd1_finder_terms`;
CREATE TABLE `eibd1_finder_terms` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `eibd1_finder_terms_common`
--

DROP TABLE IF EXISTS `eibd1_finder_terms_common`;
CREATE TABLE `eibd1_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `eibd1_finder_terms_common`
--

INSERT INTO `eibd1_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `eibd1_finder_tokens`
--

DROP TABLE IF EXISTS `eibd1_finder_tokens`;
CREATE TABLE `eibd1_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
  `phrase` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Table structure for table `eibd1_finder_tokens_aggregate`
--

DROP TABLE IF EXISTS `eibd1_finder_tokens_aggregate`;
CREATE TABLE `eibd1_finder_tokens_aggregate` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `eibd1_finder_types`
--

DROP TABLE IF EXISTS `eibd1_finder_types`;
CREATE TABLE `eibd1_finder_types` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `eibd1_languages`
--

DROP TABLE IF EXISTS `eibd1_languages`;
CREATE TABLE `eibd1_languages` (
...
--
-- Dumping data for table `eibd1_languages`
--

INSERT INTO `eibd1_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en_gb', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `eibd1_menu`
--

DROP TABLE IF EXISTS `eibd1_menu`;
CREATE TABLE `eibd1_menu` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `eibd1_menu`
--

INSERT INTO `eibd1_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Table structure for table `eibd1_menu_types`
--

DROP TABLE IF EXISTS `eibd1_menu_types`;
CREATE TABLE `eibd1_menu_types` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(11) NOT NULL,
...
--
-- Dumping data for table `eibd1_menu_types`
--

INSERT INTO `eibd1_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`) VALUES
...
--
-- Table structure for table `eibd1_messages`
--

DROP TABLE IF EXISTS `eibd1_messages`;
CREATE TABLE `eibd1_messages` (
...
--
-- Table structure for table `eibd1_messages_cfg`
--

DROP TABLE IF EXISTS `eibd1_messages_cfg`;
CREATE TABLE `eibd1_messages_cfg` (
...
--
-- Table structure for table `eibd1_modules`
--

DROP TABLE IF EXISTS `eibd1_modules`;
CREATE TABLE `eibd1_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Dumping data for table `eibd1_modules`
--

INSERT INTO `eibd1_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `eibd1_modules_menu`
--

DROP TABLE IF EXISTS `eibd1_modules_menu`;
CREATE TABLE `eibd1_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `eibd1_modules_menu`
--

INSERT INTO `eibd1_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `eibd1_newsfeeds`
--

DROP TABLE IF EXISTS `eibd1_newsfeeds`;
CREATE TABLE `eibd1_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `eibd1_overrider`
--

DROP TABLE IF EXISTS `eibd1_overrider`;
CREATE TABLE `eibd1_overrider` (
...
--
-- Table structure for table `eibd1_postinstall_messages`
--

DROP TABLE IF EXISTS `eibd1_postinstall_messages`;
CREATE TABLE `eibd1_postinstall_messages` (
...
--
-- Dumping data for table `eibd1_postinstall_messages`
--

INSERT INTO `eibd1_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Table structure for table `eibd1_redirect_links`
--

DROP TABLE IF EXISTS `eibd1_redirect_links`;
CREATE TABLE `eibd1_redirect_links` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `eibd1_schemas`
--

DROP TABLE IF EXISTS `eibd1_schemas`;
CREATE TABLE `eibd1_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `eibd1_schemas`
--

INSERT INTO `eibd1_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.6.3-2016-08-16');

-- --------------------------------------------------------

--
-- Table structure for table `eibd1_session`
--

DROP TABLE IF EXISTS `eibd1_session`;
CREATE TABLE `eibd1_session` (
...
--
-- Dumping data for table `eibd1_session`
--

INSERT INTO `eibd1_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('ga5d1doab9dm2ki9fun4b7q6a2', 0, 1, '1479815284', 'joomla|s:644:"";', 0, '');

-- --------------------------------------------------------

--
-- Table structure for table `eibd1_tags`
--

DROP TABLE IF EXISTS `eibd1_tags`;
CREATE TABLE `eibd1_tags` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `eibd1_tags`
--

INSERT INTO `eibd1_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
...
--
-- Table structure for table `eibd1_template_styles`
--

DROP TABLE IF EXISTS `eibd1_template_styles`;
CREATE TABLE `eibd1_template_styles` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `eibd1_template_styles`
--

INSERT INTO `eibd1_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
(4, 'beez3', 0, '0', 'Beez3 - Default', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/joomla_black.png","sitetitle":"Joomla!","sitedescription":"Open Source Content Management","navposition":"left","templatecolor":"personal","html5":"0"}'),
(5, 'hathor', 1, '0', 'Hathor - Default', '{"showSiteName":"0","colourChoice":"","boldText":"0"}'),
(7, 'protostar', 0, '0', 'protostar - Default', '{"templateColor":"","logoFile":"","googleFont":"1","googleFontName":"Open+Sans","fluidContainer":"0"}'),
(8, 'isis', 1, '1', 'isis - Default', '{"templateColor":"","logoFile":""}'),
(9, 'purity_iii', 0, '1', 'purity_III - Default', '{"tpl_article_info_datetime_format":"d M Y"}');

-- --------------------------------------------------------

--
-- Table structure for table `eibd1_ucm_base`
--

DROP TABLE IF EXISTS `eibd1_ucm_base`;
CREATE TABLE `eibd1_ucm_base` (
...
--
-- Dumping data for table `eibd1_ucm_base`
--

INSERT INTO `eibd1_ucm_base` (`ucm_id`, `ucm_item_id`, `ucm_type_id`, `ucm_language_id`) VALUES
(1, 1, 1, 0);

-- --------------------------------------------------------

--
-- Table structure for table `eibd1_ucm_content`
--

DROP TABLE IF EXISTS `eibd1_ucm_content`;
CREATE TABLE `eibd1_ucm_content` (
...
--
-- Table structure for table `eibd1_ucm_history`
--

DROP TABLE IF EXISTS `eibd1_ucm_history`;
CREATE TABLE `eibd1_ucm_history` (
...
--
-- Dumping data for table `eibd1_ucm_history`
--

INSERT INTO `eibd1_ucm_history` (`version_id`, `ucm_item_id`, `ucm_type_id`, `version_note`, `save_date`, `editor_user_id`, `character_count`, `sha1_hash`, `version_data`, `keep_forever`) VALUES
...
--
-- Table structure for table `eibd1_updates`
--

DROP TABLE IF EXISTS `eibd1_updates`;
CREATE TABLE `eibd1_updates` (
...
--
-- Dumping data for table `eibd1_updates`
--

INSERT INTO `eibd1_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
(1, 3, 0, 'Hebrew', '', 'pkg_he-IL', 'package', '', 0, '3.1.1.1', '', 'https://update.joomla.org/language/details3/he-IL_details.xml', '', ''),
(2, 3, 0, 'Hungarian', '', 'pkg_hu-HU', 'package', '', 0, '3.6.4.1', '', 'https://update.joomla.org/language/details3/hu-HU_details.xml', '', ''),
(3, 3, 0, 'Afrikaans', '', 'pkg_af-ZA', 'package', '', 0, '3.6.3.1', '', 'https://update.joomla.org/language/details3/af-ZA_details.xml', '', ''),
(4, 3, 0, 'Arabic Unitag', '', 'pkg_ar-AA', 'package', '', 0, '3.6.4.2', '', 'https://update.joomla.org/language/details3/ar-AA_details.xml', '', ''),
(5, 3, 0, 'Belarusian', '', 'pkg_be-BY', 'package', '', 0, '3.2.1.1', '', 'https://update.joomla.org/language/details3/be-BY_details.xml', '', ''),
(6, 3, 0, 'Bulgarian', '', 'pkg_bg-BG', 'package', '', 0, '3.4.4.2', '', 'https://update.joomla.org/language/details3/bg-BG_details.xml', '', ''),
(7, 3, 0, 'Catalan', '', 'pkg_ca-ES', 'package', '', 0, '3.6.3.1', '', 'https://update.joomla.org/language/details3/ca-ES_details.xml', '', ''),
(8, 3, 0, 'Chinese Simplified', '', 'pkg_zh-CN', 'package', '', 0, '3.4.1.1', '', 'https://update.joomla.org/language/details3/zh-CN_details.xml', '', ''),
(9, 3, 0, 'Croatian', '', 'pkg_hr-HR', 'package', '', 0, '3.6.4.1', '', 'https://update.joomla.org/language/details3/hr-HR_details.xml', '', ''),
(10, 3, 0, 'Czech', '', 'pkg_cs-CZ', 'package', '', 0, '3.6.4.1', '', 'https://update.joomla.org/language/details3/cs-CZ_details.xml', '', ''),
(11, 3, 0, 'Danish', '', 'pkg_da-DK', 'package', '', 0, '3.6.3.1', '', 'https://update.joomla.org/language/details3/da-DK_details.xml', '', ''),
(12, 3, 0, 'Dutch', '', 'pkg_nl-NL', 'package', '', 0, '3.6.3.1', '', 'https://update.joomla.org/language/details3/nl-NL_details.xml', '', ''),
(13, 3, 0, 'Estonian', '', 'pkg_et-EE', 'package', '', 0, '3.6.0.1', '', 'https://update.joomla.org/language/details3/et-EE_details.xml', '', ''),
(14, 3, 0, 'Italian', '', 'pkg_it-IT', 'package', '', 0, '3.6.4.1', '', 'https://update.joomla.org/language/details3/it-IT_details.xml', '', ''),
(15, 3, 0, 'Khmer', '', 'pkg_km-KH', 'package', '', 0, '3.4.5.1', '', 'https://update.joomla.org/language/details3/km-KH_details.xml', '', ''),
(16, 3, 0, 'Korean', '', 'pkg_ko-KR', 'package', '', 0, '3.6.4.1', '', 'https://update.joomla.org/language/details3/ko-KR_details.xml', '', ''),
(17, 3, 0, 'Latvian', '', 'pkg_lv-LV', 'package', '', 0, '3.6.2.2', '', 'https://update.joomla.org/language/details3/lv-LV_details.xml', '', ''),
(18, 3, 0, 'Macedonian', '', 'pkg_mk-MK', 'package', '', 0, '3.6.3.1', '', 'https://update.joomla.org/language/details3/mk-MK_details.xml', '', ''),
...
(21, 3, 0, 'Persian', '', 'pkg_fa-IR', 'package', '', 0, '3.6.4.1', '', 'https://update.joomla.org/language/details3/fa-IR_details.xml', '', ''),
(22, 3, 0, 'Polish', '', 'pkg_pl-PL', 'package', '', 0, '3.6.4.1', '', 'https://update.joomla.org/language/details3/pl-PL_details.xml', '', ''),
...
(25, 3, 0, 'English AU', '', 'pkg_en-AU', 'package', '', 0, '3.6.4.1', '', 'https://update.joomla.org/language/details3/en-AU_details.xml', '', ''),
(26, 3, 0, 'Slovak', '', 'pkg_sk-SK', 'package', '', 0, '3.6.4.1', '', 'https://update.joomla.org/language/details3/sk-SK_details.xml', '', ''),
(27, 3, 0, 'English US', '', 'pkg_en-US', 'package', '', 0, '3.6.4.1', '', 'https://update.joomla.org/language/details3/en-US_details.xml', '', ''),
...
(30, 3, 0, 'Tamil', '', 'pkg_ta-IN', 'package', '', 0, '3.6.4.1', '', 'https://update.joomla.org/language/details3/ta-IN_details.xml', '', ''),
(31, 3, 0, 'Thai', '', 'pkg_th-TH', 'package', '', 0, '3.6.4.1', '', 'https://update.joomla.org/language/details3/th-TH_details.xml', '', ''),
...
(36, 3, 0, 'Basque', '', 'pkg_eu-ES', 'package', '', 0, '3.6.4.1', '', 'https://update.joomla.org/language/details3/eu-ES_details.xml', '', ''),
(37, 3, 0, 'Hindi', '', 'pkg_hi-IN', 'package', '', 0, '3.3.6.2', '', 'https://update.joomla.org/language/details3/hi-IN_details.xml', '', ''),
(38, 3, 0, 'German DE', '', 'pkg_de-DE', 'package', '', 0, '3.6.4.1', '', 'https://update.joomla.org/language/details3/de-DE_details.xml', '', ''),
(39, 3, 0, 'Portuguese Brazil', '', 'pkg_pt-BR', 'package', '', 0, '3.6.4.1', '', 'https://update.joomla.org/language/details3/pt-BR_details.xml', '', ''),
(40, 3, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '3.6.3.1', '', 'https://update.joomla.org/language/details3/sr-YU_details.xml', '', ''),
(41, 3, 0, 'Spanish', '', 'pkg_es-ES', 'package', '', 0, '3.6.3.1', '', 'https://update.joomla.org/language/details3/es-ES_details.xml', '', ''),
(42, 3, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.6.4.1', '', 'https://update.joomla.org/language/details3/bs-BA_details.xml', '', ''),
(43, 3, 0, 'Serbian Cyrillic', '', 'pkg_sr-RS', 'package', '', 0, '3.6.3.1', '', 'https://update.joomla.org/language/details3/sr-RS_details.xml', '', ''),
...
(47, 3, 0, 'Swahili', '', 'pkg_sw-KE', 'package', '', 0, '3.6.4.1', '', 'https://update.joomla.org/language/details3/sw-KE_details.xml', '', ''),
(48, 3, 0, 'Montenegrin', '', 'pkg_srp-ME', 'package', '', 0, '3.3.1.1', '', 'https://update.joomla.org/language/details3/srp-ME_details.xml', '', ''),
(49, 3, 0, 'English CA', '', 'pkg_en-CA', 'package', '', 0, '3.6.4.1', '', 'https://update.joomla.org/language/details3/en-CA_details.xml', '', ''),
(50, 3, 0, 'French CA', '', 'pkg_fr-CA', 'package', '', 0, '3.5.1.2', '', 'https://update.joomla.org/language/details3/fr-CA_details.xml', '', ''),
...
(53, 3, 0, 'Dari Persian', '', 'pkg_prs-AF', 'package', '', 0, '3.4.4.1', '', 'https://update.joomla.org/language/details3/prs-AF_details.xml', '', ''),
...
(57, 3, 0, 'Slovenian', '', 'pkg_sl-SI', 'package', '', 0, '3.6.4.1', '', 'https://update.joomla.org/language/details3/sl-SI_details.xml', '', ''),
(58, 3, 0, 'Spanish CO', '', 'pkg_es-CO', 'package', '', 0, '3.6.4.1', '', 'https://update.joomla.org/language/details3/es-CO_details.xml', '', ''),
(59, 3, 0, 'German CH', '', 'pkg_de-CH', 'package', '', 0, '3.6.4.1', '', 'https://update.joomla.org/language/details3/de-CH_details.xml', '', ''),
(60, 3, 0, 'German AT', '', 'pkg_de-AT', 'package', '', 0, '3.6.4.1', '', 'https://update.joomla.org/language/details3/de-AT_details.xml', '', ''),
(61, 3, 0, 'German LI', '', 'pkg_de-LI', 'package', '', 0, '3.6.4.1', '', 'https://update.joomla.org/language/details3/de-LI_details.xml', '', ''),
(62, 3, 0, 'German LU', '', 'pkg_de-LU', 'package', '', 0, '3.6.4.1', '', 'https://update.joomla.org/language/details3/de-LU_details.xml', '', ''),
(63, 3, 0, 'English NZ', '', 'pkg_en-NZ', 'package', '', 0, '3.6.4.1', '', 'https://update.joomla.org/language/details3/en-NZ_details.xml', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `eibd1_update_sites`
--

DROP TABLE IF EXISTS `eibd1_update_sites`;
CREATE TABLE `eibd1_update_sites` (
...
--
-- Dumping data for table `eibd1_update_sites`
--

INSERT INTO `eibd1_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1479815280, ''),
(2, 'Joomla! Extension Directory', 'collection', 'https://update.joomla.org/jed/list.xml', 1, 1479815284, ''),
(3, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_3.xml', 1, 1479446448, ''),
(4, 'Joomla! Update Component Update Site', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1479446448, ''),
(5, '', 'collection', 'http://update.joomlart.com/service/tracking/list.xml', 1, 0, '');

-- --------------------------------------------------------

--
-- Table structure for table `eibd1_update_sites_extensions`
--

DROP TABLE IF EXISTS `eibd1_update_sites_extensions`;
CREATE TABLE `eibd1_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

--
-- Dumping data for table `eibd1_update_sites_extensions`
--

INSERT INTO `eibd1_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 802),
(4, 28),
...
--
-- Table structure for table `eibd1_usergroups`
--

DROP TABLE IF EXISTS `eibd1_usergroups`;
CREATE TABLE `eibd1_usergroups` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
...
--
-- Dumping data for table `eibd1_usergroups`
--

INSERT INTO `eibd1_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `eibd1_users`
--

DROP TABLE IF EXISTS `eibd1_users`;
CREATE TABLE `eibd1_users` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `eibd1_users`
--

INSERT INTO `eibd1_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(278, 'Super User', 'admin', 'admin@gmail.com', '$2y$10$utDuEy3/IIn//UX8.FA9B.zY1C/uUbyNIhDJdNHGg07KzEaZKA5wG', 0, 1, '2016-11-18 05:20:06', '2016-11-18 05:20:41', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `eibd1_user_keys`
--

DROP TABLE IF EXISTS `eibd1_user_keys`;
CREATE TABLE `eibd1_user_keys` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `eibd1_user_notes`
--

DROP TABLE IF EXISTS `eibd1_user_notes`;
CREATE TABLE `eibd1_user_notes` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `catid` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Table structure for table `eibd1_user_profiles`
--

DROP TABLE IF EXISTS `eibd1_user_profiles`;
CREATE TABLE `eibd1_user_profiles` (
...
--
-- Table structure for table `eibd1_user_usergroup_map`
--

DROP TABLE IF EXISTS `eibd1_user_usergroup_map`;
CREATE TABLE `eibd1_user_usergroup_map` (
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `eibd1_user_usergroup_map`
--

INSERT INTO `eibd1_user_usergroup_map` (`user_id`, `group_id`) VALUES
(278, 8);

-- --------------------------------------------------------

--
-- Table structure for table `eibd1_utf8_conversion`
--

DROP TABLE IF EXISTS `eibd1_utf8_conversion`;
CREATE TABLE `eibd1_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `eibd1_utf8_conversion`
--

INSERT INTO `eibd1_utf8_conversion` (`converted`) VALUES
(2);

-- --------------------------------------------------------

--
-- Table structure for table `eibd1_viewlevels`
--

DROP TABLE IF EXISTS `eibd1_viewlevels`;
CREATE TABLE `eibd1_viewlevels` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Dumping data for table `eibd1_viewlevels`
--

INSERT INTO `eibd1_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Indexes for table `eibd1_assets`
--
ALTER TABLE `eibd1_assets`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `eibd1_associations`
--
ALTER TABLE `eibd1_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Indexes for table `eibd1_banners`
--
ALTER TABLE `eibd1_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `eibd1_banner_clients`
--
ALTER TABLE `eibd1_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Indexes for table `eibd1_banner_tracks`
--
ALTER TABLE `eibd1_banner_tracks`
...
--
-- Indexes for table `eibd1_categories`
--
ALTER TABLE `eibd1_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `eibd1_contact_details`
--
ALTER TABLE `eibd1_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Indexes for table `eibd1_content`
--
ALTER TABLE `eibd1_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indexes for table `eibd1_contentitem_tag_map`
--
ALTER TABLE `eibd1_contentitem_tag_map`
...
--
-- Indexes for table `eibd1_content_frontpage`
--
ALTER TABLE `eibd1_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `eibd1_content_rating`
--
ALTER TABLE `eibd1_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `eibd1_content_types`
--
ALTER TABLE `eibd1_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`(100));

--
-- Indexes for table `eibd1_extensions`
--
ALTER TABLE `eibd1_extensions`
...
--
-- Indexes for table `eibd1_finder_filters`
--
ALTER TABLE `eibd1_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indexes for table `eibd1_finder_links`
--
ALTER TABLE `eibd1_finder_links`
...
--
-- Indexes for table `eibd1_finder_links_terms0`
--
ALTER TABLE `eibd1_finder_links_terms0`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `eibd1_finder_links_terms1`
--
ALTER TABLE `eibd1_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `eibd1_finder_links_terms2`
--
ALTER TABLE `eibd1_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `eibd1_finder_links_terms3`
--
ALTER TABLE `eibd1_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `eibd1_finder_links_terms4`
--
ALTER TABLE `eibd1_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `eibd1_finder_links_terms5`
--
ALTER TABLE `eibd1_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `eibd1_finder_links_terms6`
--
ALTER TABLE `eibd1_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `eibd1_finder_links_terms7`
--
ALTER TABLE `eibd1_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `eibd1_finder_links_terms8`
--
ALTER TABLE `eibd1_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `eibd1_finder_links_terms9`
--
ALTER TABLE `eibd1_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `eibd1_finder_links_termsa`
--
ALTER TABLE `eibd1_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `eibd1_finder_links_termsb`
--
ALTER TABLE `eibd1_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `eibd1_finder_links_termsc`
--
ALTER TABLE `eibd1_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `eibd1_finder_links_termsd`
--
ALTER TABLE `eibd1_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `eibd1_finder_links_termse`
--
ALTER TABLE `eibd1_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `eibd1_finder_links_termsf`
--
ALTER TABLE `eibd1_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `eibd1_finder_taxonomy`
--
ALTER TABLE `eibd1_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `eibd1_finder_taxonomy_map`
--
ALTER TABLE `eibd1_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Indexes for table `eibd1_finder_terms`
--
ALTER TABLE `eibd1_finder_terms`
...
--
-- Indexes for table `eibd1_finder_terms_common`
--
ALTER TABLE `eibd1_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Indexes for table `eibd1_finder_tokens`
--
ALTER TABLE `eibd1_finder_tokens`
  ADD KEY `idx_word` (`term`),
  ADD KEY `idx_context` (`context`);

--
-- Indexes for table `eibd1_finder_tokens_aggregate`
--
ALTER TABLE `eibd1_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Indexes for table `eibd1_finder_types`
--
ALTER TABLE `eibd1_finder_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Indexes for table `eibd1_languages`
--
ALTER TABLE `eibd1_languages`
...
--
-- Indexes for table `eibd1_menu`
--
ALTER TABLE `eibd1_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `eibd1_menu_types`
--
ALTER TABLE `eibd1_menu_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Indexes for table `eibd1_messages`
--
ALTER TABLE `eibd1_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Indexes for table `eibd1_messages_cfg`
--
ALTER TABLE `eibd1_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Indexes for table `eibd1_modules`
--
ALTER TABLE `eibd1_modules`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `eibd1_modules_menu`
--
ALTER TABLE `eibd1_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indexes for table `eibd1_newsfeeds`
--
ALTER TABLE `eibd1_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Indexes for table `eibd1_overrider`
--
ALTER TABLE `eibd1_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `eibd1_postinstall_messages`
--
ALTER TABLE `eibd1_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indexes for table `eibd1_redirect_links`
--
ALTER TABLE `eibd1_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_old_url` (`old_url`(100)),
  ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Indexes for table `eibd1_schemas`
--
ALTER TABLE `eibd1_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Indexes for table `eibd1_session`
--
ALTER TABLE `eibd1_session`
  ADD PRIMARY KEY (`session_id`),
  ADD KEY `userid` (`userid`),
  ADD KEY `time` (`time`);

--
-- Indexes for table `eibd1_tags`
--
ALTER TABLE `eibd1_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `eibd1_template_styles`
--
ALTER TABLE `eibd1_template_styles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
  ADD KEY `idx_home` (`home`);

--
-- Indexes for table `eibd1_ucm_base`
--
ALTER TABLE `eibd1_ucm_base`
...
--
-- Indexes for table `eibd1_ucm_content`
--
ALTER TABLE `eibd1_ucm_content`
...
--
-- Indexes for table `eibd1_ucm_history`
--
ALTER TABLE `eibd1_ucm_history`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `idx_ucm_item_id` (`ucm_type_id`,`ucm_item_id`),
  ADD KEY `idx_save_date` (`save_date`);

--
-- Indexes for table `eibd1_updates`
--
ALTER TABLE `eibd1_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Indexes for table `eibd1_update_sites`
--
ALTER TABLE `eibd1_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Indexes for table `eibd1_update_sites_extensions`
--
ALTER TABLE `eibd1_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indexes for table `eibd1_usergroups`
--
ALTER TABLE `eibd1_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `eibd1_users`
--
ALTER TABLE `eibd1_users`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `eibd1_user_keys`
--
ALTER TABLE `eibd1_user_keys`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `eibd1_user_notes`
--
ALTER TABLE `eibd1_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Indexes for table `eibd1_user_profiles`
--
ALTER TABLE `eibd1_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Indexes for table `eibd1_user_usergroup_map`
--
ALTER TABLE `eibd1_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indexes for table `eibd1_viewlevels`
--
ALTER TABLE `eibd1_viewlevels`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `eibd1_assets`
--
ALTER TABLE `eibd1_assets`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=63;
--
-- AUTO_INCREMENT for table `eibd1_banners`
--
ALTER TABLE `eibd1_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `eibd1_banner_clients`
--
ALTER TABLE `eibd1_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `eibd1_categories`
--
ALTER TABLE `eibd1_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `eibd1_contact_details`
--
ALTER TABLE `eibd1_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `eibd1_content`
--
ALTER TABLE `eibd1_content`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `eibd1_content_types`
--
ALTER TABLE `eibd1_content_types`
  MODIFY `type_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `eibd1_extensions`
--
ALTER TABLE `eibd1_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10002;
--
-- AUTO_INCREMENT for table `eibd1_finder_filters`
--
ALTER TABLE `eibd1_finder_filters`
  MODIFY `filter_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `eibd1_finder_links`
--
ALTER TABLE `eibd1_finder_links`
  MODIFY `link_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `eibd1_finder_taxonomy`
--
ALTER TABLE `eibd1_finder_taxonomy`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `eibd1_finder_terms`
--
ALTER TABLE `eibd1_finder_terms`
  MODIFY `term_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `eibd1_finder_types`
--
ALTER TABLE `eibd1_finder_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `eibd1_languages`
--
ALTER TABLE `eibd1_languages`
  MODIFY `lang_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `eibd1_menu`
--
ALTER TABLE `eibd1_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;
--
-- AUTO_INCREMENT for table `eibd1_menu_types`
--
ALTER TABLE `eibd1_menu_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `eibd1_messages`
--
ALTER TABLE `eibd1_messages`
  MODIFY `message_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `eibd1_modules`
--
ALTER TABLE `eibd1_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94;
--
-- AUTO_INCREMENT for table `eibd1_newsfeeds`
--
ALTER TABLE `eibd1_newsfeeds`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `eibd1_overrider`
--
ALTER TABLE `eibd1_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';
--
-- AUTO_INCREMENT for table `eibd1_postinstall_messages`
--
ALTER TABLE `eibd1_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `eibd1_redirect_links`
--
ALTER TABLE `eibd1_redirect_links`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `eibd1_tags`
--
ALTER TABLE `eibd1_tags`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `eibd1_template_styles`
--
ALTER TABLE `eibd1_template_styles`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `eibd1_ucm_content`
--
ALTER TABLE `eibd1_ucm_content`
  MODIFY `core_content_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `eibd1_ucm_history`
--
ALTER TABLE `eibd1_ucm_history`
  MODIFY `version_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `eibd1_updates`
--
ALTER TABLE `eibd1_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
--
-- AUTO_INCREMENT for table `eibd1_update_sites`
--
ALTER TABLE `eibd1_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `eibd1_usergroups`
--
ALTER TABLE `eibd1_usergroups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `eibd1_users`
--
ALTER TABLE `eibd1_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=279;
--
-- AUTO_INCREMENT for table `eibd1_user_keys`
--
ALTER TABLE `eibd1_user_keys`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `eibd1_user_notes`
--
ALTER TABLE `eibd1_user_notes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `eibd1_viewlevels`
--
ALTER TABLE `eibd1_viewlevels`
