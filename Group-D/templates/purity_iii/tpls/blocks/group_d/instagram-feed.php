                    ...
                    <ul class="instafeed-middle" id="carousel-instafeed">
                        <li>
                            <div class="ig-indent">
                                <div class="ig-wrapper thumbs">
                                    <a href="#">
                                        <img class="img-responsive" src="<?php echo T3_TEMPLATE_URL; ?>/images/sony_vaio.jpg" title="#sony #vaio">
                                    </a>
                            ...
                            <div class="ig-indent">
                                <div class="ig-wrapper">
                                    <a class="ig-link" href="#">
                                        <img class="img-responsive" src="<?php echo T3_TEMPLATE_URL; ?>/images/sony_laptop.jpg" title="#sony laptop">
                                    </a>
                        ...
                        <li>
                            <div class="ig-indent">
                                <div class="ig-wrapper">
                                    <a class="ig-link" href="#">
                                        <img src="<?php echo T3_TEMPLATE_URL; ?>/images/sony_vaio_laptop.jpg" title="#sony vaio laptop">
                                    </a>
                        ...
                        <li>
                            <div class="ig-indent">
                                <div class="ig-wrapper">
                                    <a class="ig-link" href="#">
                                        <img src="<?php echo T3_TEMPLATE_URL; ?>/images/macbook-pro.jpg" title="#macbook pro 13">
                                    </a>
